...
```console
Request URL: https://fathym-prd.azure-api.net/habistack/ColdQuery?dataType=Telemetry&flatten=true&includeEmulated=false&resultType=JSON&zip=false
```

For the Warm Query, use this URL:

```console
Request URL: https://fathym-prd.azure-api.net/habistack/WarmQuery?includeEmulated=false
```
...
- URL: `https://fathym-prd.azure-api.net/habistack/ColdQuery`
