...
```console
https://fathym-prd.azure-api.net/habistack/ColdQuery?flatten=false&resultType=JSON
```
...
```console
https://fathym-prd.azure-api.net/habistack/ColdQuery?flatten=false&resultType=JSON&includeEmulated=true
```
